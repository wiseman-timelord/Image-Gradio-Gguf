...
Huihui-Qwen3-VL-4B-Instruct-abliterated-Q#.gguf
```
- Here we have the main image generation model (only one), the Vanilla [FLUX.1-schnell-gguf](https://huggingface.co/city96/FLUX.1-schnell-gguf) or the NSFW [Persephone-Flux-2.0-Q8-GGUF](https://huggingface.co/pyys/Persephone-Flux-2.0-Q8-GGUF), file...
```
