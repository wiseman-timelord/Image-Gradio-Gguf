...
- Add AI edit image feature, ie outpaint, etc. Requires research and UI rethink. It would involve a panel and controls switching/hiding, because there will be spacing issues if there are any more controls on generation page.
