...
- Configure page, recently improved/sanitized the layout/text (v1.41)...  
...
- Preferences page, still quite simple, there may be a few more things here later (v1.41)...  
...
Huihui-Qwen3-VL-4B-Instruct-abliterated-Q#.gguf
```
- Here we have the main image generation model, the Vanilla model [FLUX.1-schnell-gguf](https://huggingface.co/city96/FLUX.1-schnell-gguf) or experimental NSFW models such as [FLUX.1-dev-FluxedUp-V10-GGUF](https://huggingface.co/h4shy/FLUX.1-dev-FluxedUp-V10-GGUF), (only 1)...
```
...
├── models/                        # Default model directory, though likely user will set other directory in config.
├── media/                        # images for the readme.md
└── images/                        # The graphics for the program.
└── output/                        # Images generated by program.
```
