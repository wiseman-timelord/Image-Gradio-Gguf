...
- v1.18 - Ensured that people whom dont have compile related install tools can still run via a non-compile download, without restrictions flagging required files missing.
